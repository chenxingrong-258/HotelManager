...
<div class="x">
  ...
  <div class="content">
    ...
    <div class="right">
      <div class="item">
        帐号:
        <input type="text" id="name" name="name" class="input" value="<%=name%>" placeholder="请输入登录帐号">
      </div>
      <div class="item">
        密码:
        <input type="password" id="pwd" name="pwd" class="input" value="<%=pwd%>" placeholder="请输入登录密码">
      </div>
      <div class="item">
